...
export function promoMessage(client: Client, guildId?: string) {
  ...
  const promoMessages = [
    '📝 We are trying to get feedback from our community on the possibility of splitting the R rating into a different bot to allow us to reach a broader audience. This would also allow us to have more flexibility on the R rating, including what we can add to it, how we can limit it, etc. If you have a moment, please vote on [this survey](https://form.jotform.com/222429060012037). Thank you for using Truth or Dare!',
